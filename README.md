...
[![Docker Stars](https://img.shields.io/docker/stars/ahaasler/jira.svg?style=flat)](https://hub.docker.com/rahulkathpal/docker-jira/)
[![Docker Pulls](https://img.shields.io/docker/pulls/ahaasler/jira.svg?style=flat)](https://hub.docker.com/rahulkathpal/docker-jira/)
...
1. Create the data-only container and set proper permissions:
	...
	* **Lazy way (preferred)** - Using [docker-jira-data](https://github.com/kathpalrk/docker-jira "A data-only container for docker-jira"):
